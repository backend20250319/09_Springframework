package com.ohgiraffers.chap01restapilecturesource.section03.valid;
...
public class ExceptionController {
    ...
    @ExceptionHandler(UserNMotFoundException.class)
    public ResponseEntity<ErrorResponse> handleuserException(UserNMotFoundException ex) {
    ...
    public ResponseEntity<ErrorResponse> methodValidException(MethodArgumentNotValidException ex) {
        ...
        String bindingResultCode = ex.getBindingResult().getFieldError().getCode();
