...
@SpringBootTest
class MemberRigistServiceTest {

    @Autowired
    private MemberRigistService memberRigistService;
    ...
    void testCreateTable(
        ...
        assertDoesNotThrow(
                () -> memberRigistService.registMember(newMember)
        );
    }
    ...
    void testAccessProperty(
        ...
        String registedName = MemberRigistService.registMemberAndFindName(newMember);
