...
public class AuthService {
    ...
    public TokenResponse login(LoginRequest request) {
        ...
        // matches 메소드를 이용해서 비밀번호 검증 (평문, 암호화된값)
        ...
        String accessToken = jwtTokenProvider.createToken(user.getUsername(), user.getRole()
                .name());
