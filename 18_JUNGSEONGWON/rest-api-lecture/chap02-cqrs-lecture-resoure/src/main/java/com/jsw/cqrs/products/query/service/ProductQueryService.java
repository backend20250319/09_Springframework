package com.jsw.cqrs.products.query.service;

import com.jsw.cqrs.common.dto.Pagination;
...
import com.jsw.cqrs.products.query.dto.response.ProductDto;
import com.jsw.cqrs.products.query.dto.response.ProductListResponse;
import com.jsw.cqrs.products.query.mapper.ProductMapper;
...
public class ProductQueryService {
    ...
    public ProductListResponse getProducts(ProductSearchRequest productSearchRequest) {
        ...
        ProductListResponse build = ProductListResponse.builder()
                .products(products)
