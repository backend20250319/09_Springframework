package com.jsw.cqrs.products.command.application.service;

import com.jsw.cqrs.common.service.FileStorageService;
import com.jsw.cqrs.exception.BusinessException;
import com.jsw.cqrs.exception.ErrorCode;
import com.jsw.cqrs.products.command.application.dto.request.ProductCreateRequest;
import com.jsw.cqrs.products.command.application.dto.request.ProductUpdateRequest;
import com.jsw.cqrs.products.command.domain.aggregate.Product;
import com.jsw.cqrs.products.command.domain.aggregate.ProductStatus;
...
public class ProductCommandService {
    ...
    public Long createProduct(ProductCreateRequest productCreateRequest, MultipartFile productImg) {
        ...
        // 3. productRespository entity save
    ...
    public void updateProduct(Long productCode, ProductUpdateRequest productUpdateRequest, MultipartFile productImg) {
        // 상품 코드를 이용해서 jpa를 통해서 데이터베이스에 있는 데이터를 조회하고, 영속성컨텍스트에 넣어둔다.
