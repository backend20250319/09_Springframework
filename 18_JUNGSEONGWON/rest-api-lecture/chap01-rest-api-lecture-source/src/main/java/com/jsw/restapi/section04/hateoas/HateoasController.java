package com.jsw.restapi.section04.hateoas;

import com.jsw.restapi.section02.responseentity.ResponseMessage;
    ...
    public ResponseEntity<ResponseMessage> findAllUsers(){
       ...
       List<EntityModel<UserDTO>> userWithRel =
               users.stream().map(user -> EntityModel.of(
                       user, linkTo(methodOn(HateoasController.class).findUserByNo(user.getNo())).withSelfRel(),
