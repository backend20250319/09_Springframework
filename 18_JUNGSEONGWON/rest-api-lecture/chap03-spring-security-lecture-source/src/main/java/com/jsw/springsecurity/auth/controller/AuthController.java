...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<TokenResponse>> logout(
            ...
            ResponseCookie deleteCookie = createDeleteRefreshTokenCookie(); // 만료용 쿠기 생성
    ...
    /* accessToken 이랑 refreshToken을 body와 cookie에 담아서 반환*/
