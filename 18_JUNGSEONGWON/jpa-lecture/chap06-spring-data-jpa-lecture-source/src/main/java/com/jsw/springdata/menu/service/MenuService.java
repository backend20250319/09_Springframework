package com.jsw.springdata.menu.service;


import com.jsw.springdata.menu.dto.CategoryDTO;
import com.jsw.springdata.menu.dto.MenuDTO;
import com.jsw.springdata.menu.entity.Category;
import com.jsw.springdata.menu.entity.Menu;
import com.jsw.springdata.menu.repository.CategoryRepository;
import com.jsw.springdata.menu.repository.MenuRepository;
...
//        return MenuDTO.changeMenuDto(menu);
        ...
        // 변환할려고 하는 객체 타입(menu)을 기입하면 수동으로 수기작성했던 작업을 자동 변환해준다.
    }
...
//        List<Menu> menuList = menuRepository.findByMenuPriceGreaterThan(menuPrice);
    ...
    public void modifyMenu(MenuDTO menuDTO) {
        ...
        Menu foundMenu = menuRepository.findById(menuDTO.getMenuCode())
                .orElseThrow(IllegalArgumentException::new);
        // setter를 기계적으로 만들어 놓으면 엔터니 객체가 수정에 열린 상태가 되므로
