package ohgiraffers.datajpa.menu.controller;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import ohgiraffers.datajpa.menu.dto.MenuDTO;
import ohgiraffers.datajpa.menu.service.MenuService;
...
@Slf4j // log라는 변수명으로 Logger 객체 타입의 필드가 선언되고, 생성됨
public class MenuController {
    ...
    public String findMenuByCode(@PathVariable("menuCode") int menuCode, Model model) {
        ...
        return "menu/detail"; // viewresolver라는 객체를 통해서 /resource/templates/menu/detail.html로 이동
    }
