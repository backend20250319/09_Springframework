...
public class SwaggerTestController {
    ...
    public SwaggerTestController() {
        ...
        users.add(new UserDTO(2, "user02", "pass02", "이순신"));
        users.add(new UserDTO(3, "user03", "pass03", "홍길동"));
    }
    ...
    @Operation(summary = "회원 번호로 정보 수정")
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "404", description = "잘못 입력된 파라미터")
    })
