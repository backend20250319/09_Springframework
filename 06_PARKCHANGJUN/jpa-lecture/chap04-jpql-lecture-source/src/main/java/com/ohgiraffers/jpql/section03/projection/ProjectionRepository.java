...
public class ProjectionRepository {
    ...
    public List<Object[]> scalarTypeProjection() {
        ...
        String jpql = "SELECT c.categoryCode, c.categoryName FROM Section03Category c"; // scala
        return entityManager.createQuery(jpql, Object[].class).getResultList();
    }

    public List<CategoryInfo> newCommandProjection() {
        String jpql =
                "SELECT new com.ohgiraffers.jpql.section03.projection.CategoryInfo(c.categoryCode, c.categoryName) FROM Section03Category c";
